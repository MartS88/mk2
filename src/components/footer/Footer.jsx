        ...
        <footer>
            ...
            <div className={s.icons_block}>
                ...
                <div className={s.icon}>
                    <img src={require('../../assets/payment.png')} width={98} height={25}/>
                </div>

                <div className={s.icon}>
                    <img src={require('../../assets/payment2.png')} width={114} height={20}/>
                </div>

                <div className={s.icon}>
                    <img src={require('../../assets/payment3.png')} width={61} height={36}/>
                </div>

                <div className={s.icon}>
                    <img src={require('../../assets/payment4.png')} width={110} height={24}/>
                </div>

                <div className={s.icon}>
                    <img src={require('../../assets/payment5.png')} width={87} height={40}/>
                </div>

                <div className={s.icon}>
                    <img src={require('../../assets/payment6.png')} width={151} height={60}/>
                </div>


                <div className={s.icon}>
                    <img src={require('../../assets/payment7.png')} width={56} height={52}/>
                </div>

                <div className={s.icon}>
                    <img src={require('../../assets/payment8.png')} width={104} height={32}/>
                </div>


                <div className={s.icon}>
                    <img src={require('../../assets/payment9.png')} width={100} height={18}/>
                </div>

                <div className={s.icon}>
                    <img src={require('../../assets/payment10.png')} width={99} height={24}/>
                </div>

                <div className={s.icon}>
                    <img src={require('../../assets/payment11.png')} width={64} height={22}/>
                </div>

                <div className={s.icon}>
                    <img src={require('../../assets/payment12.png')} width={151} height={60}/>
                </div>

                <div className={s.icon}>
                    <img src={require('../../assets/payment13.png')} width={67} height={18}/>
                </div>

                <div className={s.icon}>
                    <img src={require('../../assets/payment14.png')} width={151} height={60}/>
                </div>

                <div className={s.icon}>
                    <img src={require('../../assets/payment15.png')} width={98} height={17}/>
                </div>

                <div className={s.icon}>
                    <img src={require('../../assets/payment16.png')} width={151} height={60}/>
                </div>

                <div className={s.icon}>
                    <img src={require('../../assets/payment17.png')} width={124} height={43}/>
                </div>

                <div className={s.icon}>
                    <img src={require('../../assets/payment18.png')} width={123} height={26}/>
                </div>

                <div className={s.icon}>
                    <img src={require('../../assets/payment19.png')} width={123} height={30}/>
                </div>

                <div className={s.icon}>
                    <img src={require('../../assets/payment20.png')} width={100} height={27}/>
                </div>

                <div className={s.icon}>
                    <img src={require('../../assets/payment21.png')} width={97} height={45}/>
                </div>
            ...
            <div className={s.footer_block}>
                ...
                <div className={s.first}>
                    <img src={require('../../assets/logo2.png')} width={67} height={48}/>
                    ...
                    <div>
                        <img src={require('../../assets/logo3.png')} width={110} height={48}/>
                    ...
                    <ul>
                        ...
                        <li>
                            <img src={require('../../assets/facebook f.png')} width={8} height={17}/>
                        </li>
                        </a>
                        ...
                        <li>
                            <img src={require('../../assets/in.png')} width={24} height={24}/>
                        </li>
                        </a>
